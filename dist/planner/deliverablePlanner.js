 ...
 */
function buildDeliverablePlan(taskRequirements, availableDays, dailyAvailableHours, customTemplates) {
...
function buildDeliverableItems(reqs, customTemplates) {
...
function findTemplate(name, customTemplates) {
