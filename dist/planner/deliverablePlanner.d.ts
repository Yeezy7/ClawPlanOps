 ...
 */
export declare function buildDeliverablePlan(taskRequirements: TaskRequirements, availableDays?: number, dailyAvailableHours?: number, customTemplates?: Record<string, {
    sub_tasks: string[];
    evidence: string[];
}>): DeliverablePlan;
